...
const RecruiterRegistrationHero = () => {
  return (
    <section className="px-20">
      ...
      <form className="border-2 rounded px-8 py-4 mb-20 shadow-lg flex flex-col gap-6">
        ...
        <div className="flex flex-col">
          ...
          <div className="grid grid-cols-2">
            <label className="flex items-center justify-center px-6 py-2 mr-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded cursor-pointer">
              <input
                type="file"
                className="hidden"
